...
// Rutas  productos 
//Crear Producto
router.post('/admin/producto', registrarProducto);// falta agregar verificarToken,isAdmin
...
router.put('/admin/producto/:id',modificarProducto );// falta agregar verificarToken,isAdmin 

// //Borrar un producto
router.delete('/admin/producto/:id', eliminarProducto   );//falta agregar ,verificarToken,isAdmin---
